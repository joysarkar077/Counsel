...
export interface InitialAdminProfileData {
  name: string;
  email: string;
  contact: string;
  address: string;
...
export function EditAdminProfileForm({ initialData }: { initialData: InitialAdminProfileData }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccess('Admin profile updated and encrypted successfully!');
      setTimeout(() => {
