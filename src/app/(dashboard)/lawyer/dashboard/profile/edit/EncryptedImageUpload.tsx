...
export default function EncryptedImageUpload({ onUploadSuccess }: EncryptedImageUploadProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-slate-300 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors relative overflow-hidden">
      {isWorking ? (
        <div className="flex flex-col items-center gap-2 w-full">
          ...
          <div className="text-xs font-semibold text-slate-700">Encrypting & Uploading...</div>
          <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden max-w-xs">
        ...
        <>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8 text-slate-400 mb-2">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-white border border-slate-300 rounded-lg text-xs font-semibold text-slate-700 shadow-xs hover:bg-slate-50 transition-all"
          >
            Choose File
          </button>
          <input
